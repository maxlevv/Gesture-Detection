...
def random_search(X_train, y_train, X_val, y_val, scaler):
    f1_train = []
    f1_val = []
    x_axis = []
    ...
    while i <= 10:
        ...
        save_folder_path = neural_net.save_run(save_runs_folder_path=Path(r'../../saved_runs\test_max'),
...
if __name__ == '__main__':
    ...
    random_search(X_train, y_train, X_val, y_val, scaler)
