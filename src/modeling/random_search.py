...
if __name__ == '__main__':
    train_folder_path = Path(r'C:\Users\hornh\OneDrive\Dokumente\Uni\Info\MachineLearning\project_dev_repo\ml_dev_repo\data\preprocessed_frames\new_window=10,cumsum=all\train')
    val_folder_path = Path(r'C:\Users\hornh\OneDrive\Dokumente\Uni\Info\MachineLearning\project_dev_repo\ml_dev_repo\data\preprocessed_frames\new_window=10,cumsum=all\validation')
    ...
    random_search_multipro(X_train, y_train, X_val, y_val, scaler, Path(r'..\..\saved_runs\jonas_random_6'),
        author='Jonas', description='groß ohne nina, mit neuen point feature und geändertem rotate label und neuen max idle daten')
    # random_search(X_train, y_train, X_val, y_val, scaler, Path(r'C:\Users\hornh\OneDrive\Dokumente\Uni\Info\MachineLearning\project_dev_repo\ml_dev_repo\saved_runs\test_if_random_still_works'),
    #     author='Jonas', description='groß ohne nina, mit neuen point feature und geändertem rotate label und neuen max idle daten')
