...
def read_command_line_arguments():
    ...
    parser.add_argument("--events_csv",
                        help="CSV file containing a column 'prediction'/'events' with a prediction for each frame",
                        required=True)
...
def calculate_scores(events_df, ground_truth_df, bonus=20, malus=0.2):
