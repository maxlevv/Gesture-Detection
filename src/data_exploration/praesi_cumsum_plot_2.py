...
ax.step(df.index[60:60 + 180], df.loc[60:60 + 180-1, 'right_wrist_x_cumsum_5'], where='mid', color='blue', label="Cumsum für x-Koord. re. Handgelenk")
ax.step(df.index[60:60 + 180], df.loc[60:60 + 180-1, 'right_wrist_y_cumsum_5'], where='mid', color='green', label="Cumsum für y-Koord. re. Handgelenk")
...
ax.set_title("Kumulative Summe der Zwischen-Frame-Differenzen \nausgewählter Körperpunkt-Koord. für die Geste Swipe-Left", fontsize=40, pad=35)
